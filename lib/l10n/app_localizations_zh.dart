...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get dockStyleFrosted => '磨砂玻璃';

  @override
  String get dockStyleMica => '云母质感';

  @override
  String get dockStyleSolid => '纯色';

  @override
  String get dockOpacity => 'Dock 透明度';

  @override
  String get dockOpacityHigh => '高';

  @override
  String get dockOpacityMedium => '中';

  @override
  String get dockOpacityLow => '低';

  @override
  String get dockBlur => 'Dock 模糊度';

  @override
  String get dockBlurLight => '弱';

  @override
  String get dockBlurMedium => '中';

  @override
  String get dockBlurStrong => '强';

  @override
  String get appearanceAndThemeDesc => '主题风格、深色模式与 Dock 自定义';
  ...
  @override
  String get notificationPermissionStatus => '通知权限';

  @override
  String get notificationPermissionGranted => '已授权';

  @override
  String get notificationPermissionNotGranted => '未授权 — 点击申请';

  @override
  String get parallelUploadCount => '并行上传数';

  @override
  String get syncMode => '同步方式';

  @override
  String get syncModeInterval => '间隔';

  @override
  String get syncModeSchedule => '定时';

  @override
  String get scheduledSyncTimes => '定时同步时间（每天）';

  @override
  String get addTime => '添加';

  @override
  String get noScheduleTimes => '尚未设置定时时间，添加一个即可启用定时同步';

  @override
  String get accountAndSync => '账户与同步';

  @override
  String get storageAndBackup => '存储与备份';

  @override
  String get notificationsAndPermissions => '通知';

  @override
  String get appearanceAndTheme => '外观与主题';

  @override
  String get themeStyle => '主题风格';
  ...
  @override
  String get themeMiuixDesc => 'HyperOS 风格：圆角卡片、紧凑布局、小米蓝强调色';

  @override
  String get themeMaterial3Desc => 'Material You：动态取色、宽松布局';

  @override
  String get galleryColumnCount => '相册列数';

  @override
  String get backgroundSyncSettings => '后台同步设置';

  @override
  String get storageLocationDesc =>
      '照片直接存储在你的网络储存（SMB / WebDAV / NFS），无服务端、无数据库。';
  ...
  @override
  String get backupDesc => '将所有设置（含云存储凭据）导出为压缩包';

  @override
  String get backupSuccess => '备份已保存';

  @override
  String get backupFailed => '备份失败';

  @override
  String get restoreFromBackup => '恢复';

  @override
  String get restoreDesc => '从备份压缩包恢复设置';

  @override
  String get restoreConfirm => '恢复将覆盖当前设置，确定继续吗？';

  @override
  String get restoreSuccess => '已恢复，请重启应用以生效。';

  @override
  String get restoreFailed => '恢复失败';

  @override
  String get noBackupFile => '未选择备份文件';

  @override
  String get darkMode => '深色模式';

  @override
  String get darkModeLight => '浅色';

  @override
  String get darkModeDark => '深色';

  @override
  String get darkModeSystem => '跟随系统';
  ...
  @override
  String get primaryStorage => '主存储';

  @override
  String get backupUrl => '备份地址';

  @override
  String get backupUrlEmpty => '请先填写备份地址';

  @override
  String get backupRootPath => '备份根路径';

  @override
  String get allowUntrusted => '允许不安全证书';

  @override
  String get errorLabel => '错误';

  @override
  String get localView => '本地';

  @override
  String get cloudView => '云端';

  @override
  String get hevcExtention => 'HEVC 扩展';
  ...
  @override
  String get syncCompleteNotify => '同步完成通知';

  @override
  String get syncCompleteNotifyDesc => '同步结束后发送通知（关闭后保持静默）';
