...
/// 兜底用 SnackBar 主题。
///
/// 应用内提示默认走顶部的 LiquidGlassToast（见 widgets/liquid_glass_toast.dart）；
/// 本主题仅在 Overlay 不可用、提示降级为原生 SnackBar 时生效，
/// 因此底色与圆角刻意与玻璃提示条保持一致，避免降级时观感突变。
...
/// 完整 Material 3 主题（动态取色方案 + 全组件定制）。
/// 供 main.dart 与 lib/settings/theme_controller.dart 共用。
