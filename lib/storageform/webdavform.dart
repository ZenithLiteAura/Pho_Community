...
class WebDavFormState extends State<WebDavForm> {
  ...
  Future<void> testStorage() async {
    ...
    final backupUsername = backupUsernameController!.text;
    final backupPassword = backupPasswordController!.text;
    final backupRootPath = backupRootPathController!.text;
    try {
        ...
        onPressed: testSuccess
            ? () {
                ...
                SharedPreferences.getInstance().then((value) {
                  ...
                  value.setString('webdav_url2', backupUrl);
                  value.setString('webdav_username2', backupUsername);
                  value.setString('webdav_password2', backupPassword);
                  value.setString('webdav_root_path2', backupRootPath);
