...
type ImgSyncerClient interface {
	...
	SetDriveWebdavDual(ctx context.Context, in *SetDriveWebdavDualRequest, opts ...grpc.CallOption) (*SetDriveWebdavResponse, error)
	// NFS Drive
...
func (c *imgSyncerClient) SetDriveWebdavDual(ctx context.Context, in *SetDriveWebdavDualRequest, opts ...grpc.CallOption) (*SetDriveWebdavResponse, error) {
	out := new(SetDriveWebdavResponse)
	err := c.cc.Invoke(ctx, "/img_syncer.ImgSyncer/SetDriveWebdavDual", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImgSyncerServer interface {
	...
	// Webdav Drive Dual (primary + backup, 写失败自动回退)
	SetDriveWebdavDual(context.Context, *SetDriveWebdavDualRequest) (*SetDriveWebdavResponse, error)
	// NFS Drive
...
func (UnimplementedImgSyncerServer) SetDriveWebdavDual(context.Context, *SetDriveWebdavDualRequest) (*SetDriveWebdavResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetDriveWebdavDual not implemented")
}
...
func _ImgSyncer_SetDriveWebdavDual_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetDriveWebdavDualRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImgSyncerServer).SetDriveWebdavDual(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/img_syncer.ImgSyncer/SetDriveWebdavDual",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImgSyncerServer).SetDriveWebdavDual(ctx, req.(*SetDriveWebdavDualRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ImgSyncer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetDriveWebdavDual",
			Handler:    _ImgSyncer_SetDriveWebdavDual_Handler,
		},
		{
